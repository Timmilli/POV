...
void display_digital_clock(uint16_t mat[NUMBER_OF_POSITIONS], clock_values_t *cv, uint8_t force_redraw){
    ...
    if (clock_updated >= 2 || force_redraw) //Check if the minutes have been updated
